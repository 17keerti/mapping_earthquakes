...
// 1. Add a 2nd layer group for the tectonic plate data and 3rd layer group for the major earthquake data.
let allEarthquakes = new L.LayerGroup();
let tectonicPlates = new L.LayerGroup();
let majorEarthquake = new L.LayerGroup();

// 2. Add a reference to the tectonic plates group to the overlays object and reference to the major earthquake group to the overlays object.
let overlays = {
